...
const { include, synthetize, regex } = require('../src/fastly/include-util');
...
describe('Testing include-util.js', () => {
  ['simple'].forEach((f) => {
    ...
    it('#regex', () => {
      const res = regex('some content with a {"regex:block.rgx"}', path.resolve(__dirname, 'fixtures/tinyrgx.rgx'));
